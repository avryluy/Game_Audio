...
#ifndef LowPassFilterConfig_H
#define LowPassFilterConfig_H
...
namespace LowPassFilterConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 32502;
}

#endif // LowPassFilterConfig_H
