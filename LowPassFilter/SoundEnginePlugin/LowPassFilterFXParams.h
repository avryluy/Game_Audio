...
#ifndef LowPassFilterFXParams_H
#define LowPassFilterFXParams_H
...
struct LowPassFilterNonRTPCParams
{
};

struct LowPassFilterFXParams
    : public AK::IAkPluginParam
{
    LowPassFilterFXParams();
    LowPassFilterFXParams(const LowPassFilterFXParams& in_rParams);
    ...
    LowPassFilterRTPCParams RTPC;
    LowPassFilterNonRTPCParams NonRTPC;
};

#endif // LowPassFilterFXParams_H
