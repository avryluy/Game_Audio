...
class LowPassFilterPlugin final
...
DECLARE_AUDIOPLUGIN_CONTAINER(LowPassFilter);	// Exposes our PluginContainer structure that contains the info for our plugin
